...
void ShortcutManager::initializeShortcutsList()
{
    ...
    shortcutsList.append({tr("Restore from Trash"), "undo", {}, {}});
    ...
    shortcutsList.append({tr("Copy OCR Text"), "copyocrtext", QStringList(QKeySequence(Qt::CTRL | Qt::Key_C).toString()), {}});
    ...
    shortcutsList.append({tr("Original Size"), "originalsize", QStringList(QKeySequence(Qt::CTRL | Qt::Key_1).toString()), {}});
    shortcutsList.append({tr("Zoom to Fit"), "zoomtofit", QStringList(QKeySequence(Qt::CTRL | Qt::Key_0).toString()), {}});
    shortcutsList.append({tr("Default Zoom"), "defaultzoom", QStringList(QKeySequence(Qt::CTRL | Qt::Key_Period).toString()), {}});
    shortcutsList.append({tr("Fill Window"), "fillwindow", QStringList(QKeySequence(Qt::CTRL | Qt::Key_2).toString()), {}});
    shortcutsList.append({tr("Navigation Resets Zoom"), "navresetszoom", {}, {}});
    shortcutsList.append({tr("Rotate Right"), "rotateright", QStringList(QKeySequence(Qt::CTRL | Qt::Key_Right).toString()), {}});
    shortcutsList.append({tr("Rotate Left"), "rotateleft", QStringList(QKeySequence(Qt::CTRL | Qt::Key_Left).toString()), {}});
    shortcutsList.append({tr("Mirror"), "mirror", QStringList({QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_Right).toString(), QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_Left).toString()}), {}});
    shortcutsList.append({tr("Flip"), "flip", QStringList({QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_Up).toString(), QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_Down).toString()}), {}});
    shortcutsList.append({tr("Reset Transformation"), "resettransformation", QStringList(QKeySequence(Qt::Key_T).toString()), {}});
    shortcutsList.append({tr("Revert Transformation"), "reverttransform", QStringList(QKeySequence(Qt::CTRL | Qt::Key_Z).toString()), {}});
    shortcutsList.append({tr("Crop"), "crop", QStringList(QKeySequence(Qt::CTRL | Qt::Key_T).toString()), {}});
    shortcutsList.append({tr("90% Size"), "resize90", {}, {}});
    shortcutsList.append({tr("80% Size"), "resize80", {}, {}});
    shortcutsList.append({tr("75% Size"), "resize75", {}, {}});
    shortcutsList.append({tr("50% Size"), "resize50", {}, {}});
    shortcutsList.append({tr("25% Size"), "resize25", {}, {}});
    ...
    shortcutsList.append({tr("Full Screen"), "fullscreen", QStringList({QKeySequence(Qt::Key_F11).toString(), QKeySequence(Qt::ALT | Qt::Key_Return).toString(), QKeySequence(Qt::Key_F).toString(), QKeySequence(Qt::CTRL | Qt::Key_3).toString()}), {}});
    shortcutsList.append({tr("OCR"), "ocr", QStringList(QKeySequence(Qt::Key_O).toString()), {}});
